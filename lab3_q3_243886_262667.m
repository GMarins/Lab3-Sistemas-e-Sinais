...
%Série de Fourier em Tempo Discreto. A reconstrução do sinal valida nossa
%solução analítica pois converge para o formato original.
clc
clear all
...
figure
stem(k,X3(k)) %Como o sinal transformado é real, podemos representá-lo num único gráfico
xlabel('k')
